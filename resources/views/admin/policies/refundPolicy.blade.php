...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">refund Policy </h4>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-10">
                                    <h5 class="card-title mb-0">refund Policy List </h5>
                                </div>
                                <div class="col-2 text-right">
                                    <a href="{{route('addPolicies',['slug'=>'refund-policie'])}}"
                                        class="btn btn-outline-success add-btn"><i
                                            class="ri-add-line align-bottom me-1"></i> Add refund Policy</a>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <table id="example"
                                ...
                                <tbody>
                                    ...
                                    @forelse($refund_policie as $key => $val)
    ...
    <script>
        $('.delete_btn').on('click',function(){
            var refund_policy_id = $(this).data('id');
            swal({
                title: 'Are you sure?',
                ...
                if (confirm) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#removeRow'+refund_policy_id).hide();
                        }
                    });
                }
